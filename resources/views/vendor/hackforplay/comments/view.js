$(function(){
	...
	$('<div>').addClass('panel-body row').append(
		$('<div>').addClass('col-xs-12 col-sm-6').append(
			$('<div>').addClass('row').append(
				$('<div>').addClass('col-xs-12 col-sm-5 comment-thumbnail').append(
					$('<img>').addClass('h4p_thumbnail img-responsive').css('max-height', 187)
				)
			).append(
				$('<div>').addClass('col-xs-3 col-sm-2 comment-user-icon').append(
					$('<img>').addClass('img-circle comment-item-padding')
				)
			).append(
				$('<div>').addClass('col-xs-9 col-sm-5').append(
		...
		$('<div>').addClass('col-xs-12 col-sm-6').append(
			$('<div>').addClass('row').append(
				$('<div>').addClass('col-xs-12 col-sm-12 comment-body').css('min-height', '60px')
			).append(
				$('<div>').addClass('col-xs-6 col-sm-12 comment-footer').append(
					$('<p>').addClass('label pull-right')
				)
			).append(
				$('<div>').addClass('col-xs-6 col-sm-12').append(
