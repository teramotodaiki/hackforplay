	...
	<div class="modal-dialog">
		<div class="modal-content">
		    ...
		    <div class="modal-body alert alert-danger">
		    	<p>ハックフォープレイは、パソコンで遊べるように作られています</p>
		    	<p>プログラミングをするときに、キーボードが必要になりますので、パソコンでプレイしていただきますよう、お願いいたします</p>
		    	<h3 class="text-center"><span class="label label-danger">http://hackforplay.xyz</span></h4>
		    </div>
		</div>
	</div>
